...
class SportVuData:
    def __init__(self):
        ...
        self.rebounding_url = "http://stats.nba.com/js/data/sportvu/2014/reboundingTeamData.json"
        ...
        self.shooting_url = "http://stats.nba.com/js/data/sportvu/2014/shootingTeamData.json"
        self.shooting_response = urllib2.urlopen(self.shooting_url)
        self.shooting_data = json.loads(self.shooting_response.read())

        self.speed_url = "http://stats.nba.com/js/data/sportvu/2014/speedTeamData.json"
        self.speed_response = urllib2.urlopen(self.speed_url)
        self.speed_data = json.loads(self.speed_response.read())

        self.catch_shoot_url = "http://stats.nba.com/js/data/sportvu/2014/catchShootTeamData.json"
