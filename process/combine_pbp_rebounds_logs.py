...
class ReboundLogsPbp:
    def __init__(self, rebound_log_data, pbp_data):
        self.rebound_log_data = rebound_log_data
        self.pbp_data = pbp_data

    def combine_pbp_and_rebound_logs_for_player_for_period(self, player_id, period, game_id):
        ...
        rebound_logs_player_period = self.rebound_log_data[(self.rebound_log_data['PERIOD'] == period) & (self.rebound_log_data['PLAYER_ID'] == player_id)]
